        ...
        <>
            <Header />
                <PageContainer>
                    ...
                    <p>Explore nossa seleção de pets em busca de um lar. Cada rostinho tem uma história única, esperando por um novo capítulo ao seu lado.</p>
                    
                    {pets.length === 0 ? (
                        <StyledText>Todos os pets já foram adotados!</StyledText>
                    ) : (
                        <PetsContainer>
                            {pets.map((pet) => (
                            <PetInfo key={pet.id}>
