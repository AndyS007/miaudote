        ...
        .catch((error) =>{
            if(error.response.status === 404){
                return Swal.fire({
                    ...
                    text: 'O pet que você está procurando não foi encontrado.',
                    icon: 'error',
            ...
            <PageContainer>
                ...
                <InfoPrincipal>
                    <DivInfo>
                        <div>
                            <h3>{pet.name}</h3>
                            <p>Postado em {formattedDate} por {pet.ownerName}</p>
                        ...
                        <button disabled={!isPetAvailable} onClick={popup}>QUERO ADOTAR</button>
                    </DivInfo>
                    <img src={pet.photo} />
                </InfoPrincipal>
                <InfosSecundarias>
